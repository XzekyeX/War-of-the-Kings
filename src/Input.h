...
private:
	...
	static bool keyTyped[MAX_KEYS];
	static bool keyState[MAX_KEYS];
	static bool buttons[MAX_BUTTONS];
	static bool buttonState[MAX_BUTTONS];
	static bool buttonClicked[MAX_BUTTONS];
	static double mouseX, mouseY;

public:
	Input();
	static bool isKeyDown(unsigned int key);
	static bool isKeyTyped(unsigned int key);
	static bool isButtonDown(unsigned int key);
	static bool isButtonClicked(unsigned int key);
